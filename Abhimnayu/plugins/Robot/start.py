...
from Abhimnayu import Telegram, YouTube, app
from Abhimnayu.misc import SUDOERS
from Abhimnayu.plugins.Robot.playlist import del_plist_msg
from Abhimnayu.plugins.Robot.sudoers import sudoers_list
from Abhimnayu.utils.database import (add_served_chat,
                                       add_served_user,
                                       blacklisted_chats,
                                       get_assistant, get_lang,
                                       get_userss, is_on_off,
                                       is_served_private_chat)
from Abhimnayu.utils.decorators.language import LanguageStart
from Abhimnayu.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
...
async def start_comm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgQAAxkBAAEFEtVirYq__x3IXDvJgxU5WXOBcjclSQACoBAAAkJZ_QQGF7UgO3LFICQE")
